...
var spanElem = document.getElementById('matCount');
...
var spanElem2 = document.getElementById('msgCount');
spanElem2.innerHTML = 23;
...
newDiv2.id = 'hobbies';
newDiv2.innerHTML = 'Long romantic walks on the beach, candle light Big Mac dinners and tormenting the King.';
data.appendChild(newDiv2);
...
newDiv3.id = 'location';
newDiv3.innerHTML = 'Honolulu, HI';
data.appendChild(newDiv3);
...
newDiv4.id = 'wants';
newDiv4.innerHTML = 'Looking for a Mrs. McDonald.';
data.appendChild(newDiv4);
...
var matchElem2 = document.getElementsByClassName('otherAge')[0];
matchElem2.innerHTML = 'Age 48';
